...
def cuboid(alpha):
    ...
    mdb.jobs['kolokwium'].writeInput(consistencyChecking=OFF)
    mdb.jobs['kolokwium'].waitForCompletion()


def	dataT ():
	odbName='C:/temp/kolokwium.odb'
...
def function1(p, fi, param):
    ...
    Teksp=[144.8127899, 97.45737457,67.24383545,48.55483246,37.16452026,30.28382683,]
    leng=len(Teksp)
    a1=p[0]
    cuboid(a1)
    Tobl=dataT()
