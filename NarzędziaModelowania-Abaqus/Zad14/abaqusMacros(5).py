...
def Macro1(P, robota):
    ...
    mdb.models['Model-1'].materials['Material-1'].Plastic(table=((200.0, 0.0), 
        (300.0, 0.1)))
    mdb.models['Model-1'].RectangularProfile(name='Prostokat', a=20.0, b=20.0)
    mdb.models['Model-1'].profiles['Prostokat'].setValues(a=200.0, b=200.0)
    mdb.models['Model-1'].BeamSection(name='Section-1', 
        integration=DURING_ANALYSIS, poissonRatio=0.3, profile='Prostokat', 
