...
// L1
    /* case 0: */
    /*   strncpy(papi_event_mth[thread_id][0].name, "MEM_UOPS_RETIRED.ALL_LOADS", 100); */
    /*   break; */

    /* case 1: */
    /*   strncpy(papi_event_mth[thread_id][1].name, "MEM_LOAD_UOPS_RETIRED.L1_HIT", 100); */
    /*   break; */

    /* case 2: */
    /*   strncpy(papi_event_mth[thread_id][2].name, "MEM_LOAD_UOPS_RETIRED.HIT_LFB", 100); */
    /*   break; */
...
// L2
    ...
    /* case 1: */
    /*   strncpy(papi_event_mth[thread_id][1].name, "MEM_LOAD_UOPS_RETIRED.L1_MISS", 100); */
    /*   break; */

    /* case 2: */
    /*   strncpy(papi_event_mth[thread_id][2].name, "MEM_LOAD_UOPS_RETIRED.L2_HIT", 100); */
    /*   break; */
...
// L3
    ...
    /* case 1: */
    /*   strncpy(papi_event_mth[thread_id][1].name, "MEM_LOAD_UOPS_RETIRED.L2_MISS", 100); */
    /*   break; */

    /* case 2: */
    /*   strncpy(papi_event_mth[thread_id][2].name, "MEM_LOAD_UOPS_RETIRED.L3_HIT", 100); */
    /*   break; */
    ...
    case 0:
      ...
      //strncpy(papi_event_mth[thread_id][0].name, "CPU_CLK_UNHALTED", 100);
      break;

    case 1:
      strncpy(papi_event_mth[thread_id][1].name, "PAPI_REF_CYC", 100);
      //strncpy(papi_event_mth[thread_id][1].name, "CPU_CLK_UNHALTED.REF?", 100);
      //strncpy(papi_event_mth[thread_id][1].name, "PAPI_TOT_INS", 100);
      //strncpy(papi_event_mth[thread_id][1].name, "INST_RETIRED.ANY?", 100);
      break;

    case 2:
      strncpy(papi_event_mth[thread_id][2].name, "L2_LINES_IN.ALL", 100);
      break;

    case 3:
      strncpy(papi_event_mth[thread_id][3].name, "L2_TRANS.RFO", 100);
      break;

    case 4:
      strncpy(papi_event_mth[thread_id][4].name, "MEM_LOAD_UOPS_L3_MISS_RETIRED.REMOTE_HITM", 100);
      //strncpy(papi_event_mth[thread_id][4].name, "MEM_LOAD_UOPS_L3_HIT_RETIRED.XSNP_MISS", 100);
      //strncpy(papi_event_mth[thread_id][4].name, "MEM_LOAD_UOPS_L3_HIT_RETIRED.XSNP_HITM", 100);
      //strncpy(papi_event_mth[thread_id][4].name, "MEM_LOAD_UOPS_L3_HIT_RETIRED.XSNP_HIT", 100);
      // etc.
      break;

    case 5:
      strncpy(papi_event_mth[thread_id][5].name, "INST_RETIRED.ANY", 100);
      break;

    case 6:
      strncpy(papi_event_mth[thread_id][6].name, "MEM_UOPS_RETIRED.ALL_LOADS", 100);
      //strncpy(papi_event_mth[thread_id][6].name, "MEM_LOAD_UOPS_RETIRED.ALL", 100);
      break;
