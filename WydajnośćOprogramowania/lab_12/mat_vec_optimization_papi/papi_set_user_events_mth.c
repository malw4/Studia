...
// ? L2_LINES_IN.ALL = OFFCORE_RESPONSE_0:ANY_DATA:ANY_RFO:L3_HIT:SNP_ANY + OFFCORE_RESPONSE_0:ANY_DATA:ANY_RFO:L3_MISS_LOCAL:SNP_ANY ???
    ...
    case 4:
      strncpy(papi_event_mth[thread_id][4].name, "PAPI_L3_TCM", 100);
...
//strncpy(papi_event_mth[thread_id][5].name, "OFFCORE_RESPONSE_0:ANY_DATA:LLC_MISS_LOCAL:LLC_MISS_REMOTE", 100);
...
// OFFCORE_RESPONSE_0:ANY_DATA:ANY_RFO:L3_MISS_LOCAL:SNP_ANY - local DRAM ???
      //strncpy(papi_event_mth[thread_id][5].name, "OFFCORE_RESPONSE_1:ANY_DATA:ANY_RFO:L3_MISS_LOCAL:SNP_ANY", 100);
...
//(OFFCORE_RESPONSE_x:ANY_DATA:LLC_MISS_LOCAL:LLC_MISS_REMOTE + OFFCORE_RESPONSE_x:ANY_RFO:LLC_MISS_LOCAL:LLC_MISS_REMOTE) * 64
//strncpy(papi_event_mth[thread_id][5].name, "OFFCORE_RESPONSE_0:ANY_DATA:ANY_RFO:L3_MISS_LOCAL", 100);


strncpy(papi_event_mth[thread_id][5].name, "OFFCORE_RESPONSE_0:ANY_DATA:ANY_RFO:L3_MISS_LOCAL:L3_MISS_REMOTE:SNP_ANY", 100);

//strncpy(papi_event_mth[thread_id][5].name, "PAPI_L3_TCM", 100);
...
// + events for memory latency
    ...
    case 6:
      ...
      //strncpy(papi_event_mth[thread_id][6].name, "PAPI_L3_TCM", 100);
      break;
