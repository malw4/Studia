...
// L3
    ...
    case 2:
      strncpy(papi_event[2].name, "MEM_LOAD_UOPS_RETIRED.L2_MISS", 100);
      break;
    ...
    case 4:
      strncpy(papi_event[4].name, "PAPI_REF_CYC", 100);
      break;

    case 5:
      strncpy(papi_event[5].name, "PAPI_TOT_INS", 100);
      break;

    case 6:
      strncpy(papi_event[6].name, "PAPI_TOT_CYC", 100);
      break;
