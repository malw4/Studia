...
// L3
    ...
    case 0:
      strncpy(papi_event[0].name, "PAPI_TOT_CYC", 100);
      break;

    case 1:
      strncpy(papi_event[1].name, "PAPI_REF_CYC", 100);
      break;


    case 2:
      strncpy(papi_event[2].name, "MEM_LOAD_UOPS_RETIRED.L1_MISS", 100);
      break;
    ...
    case 6:
      strncpy(papi_event[6].name, "PAPI_TOT_INS", 100);
      break;

    case 5:
      strncpy(papi_event[5].name, "MEM_UOPS_RETIRED.ALL_LOADS", 100);
      break;
...
double papi_return_clock_ratio( void ){
  ...
  double clock_ratio = (double)papi_event[0].sum_of_results/(double)papi_event[1].sum_of_results;
